...
ConnectionWindow::ConnectionWindow(wxWindow* parent, const wxString& title, const wxPoint& pos, const wxSize& size, const char* qrData)
	: wxFrame(parent, wxID_ANY, title, pos, size)
{
	{	
		qrcodegen::QrCode qr0 = qrcodegen::QrCode::encodeText(qrData, qrcodegen::QrCode::Ecc::MEDIUM);
